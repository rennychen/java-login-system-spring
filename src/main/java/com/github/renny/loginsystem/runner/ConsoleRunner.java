...
//註冊
private void register(Scanner scan, AuthService authService){
    try{
...
//登入
private void login(Scanner scan, LoginSession session, AuthService authService){
    try{
        System.out.print("請輸入帳號:");
        String account = scan.nextLine();
...
//顯示目前登入身分
private void showCurrentUser(LoginSession session){
    try{
...
//登出
private void logout(LoginSession session){
